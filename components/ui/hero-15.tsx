...
export default function Hero15({
  ...
  return (
    <section className="relative isolate flex w-full overflow-hidden bg-neutral-950 px-1.5 py-1.5 text-white antialiased">
      <motion.div
        className="relative flex w-full flex-col overflow-hidden bg-neutral-950 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.06)]"
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        >
          <a
            href="#"
            className="group/brand inline-flex items-center transition-[opacity,transform] duration-200 ease-out hover:opacity-80 active:scale-[0.96]"
          >
            <Image src="/images/logo.png" alt="Logo" width={400} height={160} className="h-12 w-auto object-contain" />
          </a>
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 pt-16 pb-16 text-center sm:px-12 sm:pt-20 lg:px-24">
          ...
          >
            <p className="text-[10px] font-semibold tracking-[0.25em] text-white/20 uppercase">Our Apps</p>
            <Image
              src="/images/image.png"
              alt="Aqeel and Riyocut"
              width={600}
              height={150}
